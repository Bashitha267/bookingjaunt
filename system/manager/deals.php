...
<head>
    ...
    <title>Deals of the Day — Manager · BookingJaunt</title>
        ...
        <div class="glass-table" style="overflow-x:auto;">
            ...
            <table class="w-full text-left" style="min-width:900px;">
                ...
                <tbody>
                    ...
                    ?>
                    <tr class="glass-tr">
                        <td class="glass-td"><div class="font-bold"><?php echo htmlspecialchars($deal['property_name']); ?></div><div style="color:rgba(255,255,255,0.45);font-size:0.75rem;"><i class="fas fa-map-marker-alt mr-1"></i><?php echo htmlspecialchars($deal['city']); ?></div></td>
