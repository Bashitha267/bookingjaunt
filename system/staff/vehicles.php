                                ...
                                <?php foreach ($vehicles as $vehicle): ?>
                                    <tr class="hover:bg-white/5 transition-colors">
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <a href="property_details.php?id=<?php echo (int)$vehicle['id']; ?>" class="px-3 py-2 rounded-lg text-[11px] font-bold uppercase tracking-widest bg-white/10 hover:bg-white/20 text-white transition-all">
                                                View
                                            </a>
                                        </td>
                                    </tr>
