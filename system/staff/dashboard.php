...
<head>
    ...
    <title>Staff Dashboard - Bookingjaunt</title>
        ...
        <header class="glass-header sticky top-0 z-40 px-4 lg:px-8 py-4 flex justify-between items-center">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-sky-300 font-medium hidden lg:block uppercase tracking-widest">Welcome to the Staff Console</p>
                </div>
            </div>
