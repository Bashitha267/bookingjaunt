        ...
        <form id="property-form"
            ...
            <div class="wizard-step active" data-step="1">
                ...
                <div class="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
                    ...
                    <!-- Vehicle -->
                    <a href="vehicle_register_wizard.php" class="group relative border-2 rounded-2xl p-4 md:p-8 cursor-pointer hover:bg-blue-50/50 transition-all text-center border-gray-200 flex flex-col items-center">
                        <div class="w-12 h-12 md:w-16 md:h-16 bg-blue-50 text-[#006ce4] rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-105 transition-transform shadow-sm">
